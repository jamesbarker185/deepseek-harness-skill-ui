...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".skp-open-full{opacity:0;font-size:12px;line-height:1;transition:opacity 120ms}" +
      ".skp-panel-toggle:hover .skp-open-full{opacity:1}" +
      ".skp-open-full:hover{color:var(--dsw-alias-label-primary)}" +
      ".skp-chev{font-size:11px;line-height:1;opacity:0.9}" +
    ...
    module.exports = {
      ...
      apply(ctx) {
        ...
        // Ctrl+/ jumps the cursor to a search box: the sidebar section's when
        // it is showing, otherwise the full palette (which opens if needed).
        function focusPaletteSearch() {
          if (typeof document === "undefined") return;
          if (store.open) {
            var overlaySearch = document.querySelector(".skp-search");
            if (overlaySearch !== null && overlaySearch !== undefined && typeof overlaySearch.focus === "function") overlaySearch.focus();
            return;
          }
          var panelSearch = document.querySelector(".skp-panel-search");
          if (panelSearch !== null && panelSearch !== undefined && typeof panelSearch.focus === "function") {
            panelSearch.focus();
            return;
          }
          open();
        ...
        ctx.effect(function () {
          ...
          function onKey(e) {
            ...
            else if ((e.ctrlKey || e.metaKey) && e.key === "/") { e.preventDefault(); focusPaletteSearch(); }
